    ...
    return (
        <header className="py-[15px] px-[20px] border fixed w-full  ">
            <section className="flex flex-row justify-between">
                <Link to="/" className="text-gray-900 font-bold font-sans text-md">AIcademy Logo</Link>
                <div className="border border-gray-300 px-2 py-1 rounded-md bg-slate-300 text-gray-800 text-md font-bold h-9 hover:bg-gray-600 hover:text-white active:bg-gray-500 cursor-pointer">
                    Add Subjects
                </div>
                <form className="">
                ...
                <div className="flex justify-between">
                    ...
                    <button
                        class="select-none   rounded-lg bg-transparent py-1 px-2 text-center align-middle font-sans text-md border border-gray-500 font-bold uppercase text-gray-900 shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85]"
                        type="button"
