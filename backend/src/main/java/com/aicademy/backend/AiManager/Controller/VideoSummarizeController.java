...
////                "use tailwind css to style the element. Use class instead of className to add css. Do not add any unnecessary letter like ```jsx . Response exactly like this so that i can directly use it in react:" +
